...
public class Message implements Serializable {
    ...
    // 表示发送消息后，是否需要等待消息同步刷新到磁盘上。
    // 如果broker配置为ASYNC_MASTER，那么只需要消息在master上刷新到磁盘即可；
    // 如果配置为SYNC_MASTER，那么还需要等待slave也刷新到磁盘。
    ...
    // 消息的延迟级别，0表示不延迟，大于0会延迟特定时间才被消费
    // delayTimeLevel 存在properties中
