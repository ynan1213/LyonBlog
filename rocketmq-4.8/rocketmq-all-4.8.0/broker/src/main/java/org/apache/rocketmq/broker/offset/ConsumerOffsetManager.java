...
public class ConsumerOffsetManager extends ConfigManager {
    ...
    private ConcurrentMap<String/* topic@group */, ConcurrentMap<Integer, Long>> offsetTable = new ConcurrentHashMap<String, ConcurrentMap<Integer, Long>>(
        512);
    ...
    public void scanUnsubscribedTopic() {
        ...
        while (it.hasNext()) {
            ...
            if (arrays.length == 2) {
                ...
                if (null == brokerController.getConsumerManager().findSubscriptionData(group, topic) && this
                    .offsetBehindMuchThanData(topic, next.getValue())) {
                    it.remove();
