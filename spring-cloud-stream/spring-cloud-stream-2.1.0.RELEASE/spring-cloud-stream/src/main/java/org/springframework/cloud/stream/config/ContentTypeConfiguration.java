...
class ContentTypeConfiguration {
	...
	/**
	 * @StreamMessageConverter 注解内部是 @Qualifier
	 * 作用是这里只会注入被 @StreamMessageConverter 注解修饰的 MessageConverter bean 类型
     *
	 * 默认情况下容器中好像没有 @StreamMessageConverter 注解的 MessageConverter
	 */
	@Bean
