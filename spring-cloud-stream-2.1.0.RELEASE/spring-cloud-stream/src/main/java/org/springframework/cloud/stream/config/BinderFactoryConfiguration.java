...
public class BinderFactoryConfiguration {
    ...
    /**
     * 解析 META-INF/spring.binders 配置文件
     */
    @Bean
     ...
     * @param compositeMessageConverterFactory 来自 ContentTypeConfiguration#compositeMessageConverterFactory 方法
     */
    @Bean
    ...
    public MessageSourceBindingTargetFactory messageSourceFactory(CompositeMessageConverterFactory compositeMessageConverterFactory,
        ...
        return new MessageSourceBindingTargetFactory(compositeMessageConverterFactory.getMessageConverterForAllRegistered(),
