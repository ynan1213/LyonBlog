...
/**
 *  netty为什么会提供 一个自己的Future　？　
 *  java原生的Future的get() 方法是有可能导致程序的阻塞的,
 *  在netty的Futrue中添加了监听器, 一旦定义的Future任务有返回, 监听器会被通知,再去get()
 *  规避了程序阻塞的情况
 *
 */

/**
 *     看一下,原生Futrue中提供的例子, 异步提交任务, 得到Future对象
...
public interface Future<V> extends java.util.concurrent.Future<V> {
     ...
     */
    /**
     *  使用了观察者设计模式, 给这个future添加监听器, 一旦Future 完成, listenner 立即被通知
     * @param listener
     * @return
     */
