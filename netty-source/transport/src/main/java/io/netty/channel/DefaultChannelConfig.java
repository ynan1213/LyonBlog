 ...
 * 是ChannelConfig的一种默认的实现, 里面配置 默认的channel 常量的配置信息
 */
public class DefaultChannelConfig implements ChannelConfig {
    ...
    private volatile int connectTimeoutMillis = DEFAULT_CONNECT_TIMEOUT;//默认连接超时时间，客户端用
    ...
    public DefaultChannelConfig(Channel channel) {
        // 关注: AdaptiveRecvByteBufAllocator 创建了一个可适配的接受字节缓冲的适配器
