 ...
 * generated in the com.epichust.main.service package. 
...
public class ObjectFactory {
    ...
    private final static QName _SayBye_QNAME = new QName("http://service.main.epichust.com/", "sayBye");
    private final static QName _SayByeResponse_QNAME = new QName("http://service.main.epichust.com/", "sayByeResponse");
    private final static QName _SayHello_QNAME = new QName("http://service.main.epichust.com/", "sayHello");
    private final static QName _SayHelloResponse_QNAME = new QName("http://service.main.epichust.com/", "sayHelloResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.epichust.main.service
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://service.main.epichust.com/", name = "sayBye")
     ...
     */
    @XmlElementDecl(namespace = "http://service.main.epichust.com/", name = "sayByeResponse")
     ...
     */
    @XmlElementDecl(namespace = "http://service.main.epichust.com/", name = "sayHello")
     ...
     */
    @XmlElementDecl(namespace = "http://service.main.epichust.com/", name = "sayHelloResponse")
