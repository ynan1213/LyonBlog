...
public class DefaultSecurityManager extends SessionsSecurityManager
{
    ...
    {
        // 检查context中是否含有session：先从context中的backingMap缓存中直接获取，再从缓存中获取subject，再通过 subject.getSession(false) 获取
        ...
        try
        {
            //Context couldn't resolve it directly, let's see if we can since we have direct access to  the session manager:
