 ...
 * <pre>
 *     todo 请向下类型转换 成SocketChannelConfig  ,或者 去设置
 * {@link Channel} ch = ...;
 ...
 *  todo 还有很多ChannelConfig子类的选项可以配置 , 比如说可以配置TCPIP 在 SocketChannelConfig中
 */
// todo 我们常用的是它的实现类 DefaultChannelConfig
public interface ChannelConfig {
     ...
     */ // todo 设置指定的 ChannelOption  使用指定的值 , 泛型T 就是值的类型
